使用方法
```
$ ansible-playbook -i contrib/ec2.py mysql.yml -e "mysql_tag=class_database" -e 'acname=stop' --tags stop
...
$ ansible-playbook -i contrib/ec2.py mysql.yml -e "mysql_tag=class_database" -e 'acname=disable' --tags disable
$ ansible-playbook -i contrib/ec2.py mysql.yml -e "mysql_tag=class_database" -e 'acname=restart' --tags restart
